...
<div class="col-md-6"><label class="form-label" for="IncidenciaProducto">SKU</label><select class="form-select" id="IncidenciaProducto" name="productoId" required><option value="">Selecciona producto</option><?php foreach ($productos as $producto): ?><option value="<?= (int)$producto['PRODUCTOSID'] ?>"><?= htmlspecialchars($producto['Sku'].' - '.$producto['Descripcion'], ENT_QUOTES, 'UTF-8') ?></option><?php endforeach; ?></select></div>
